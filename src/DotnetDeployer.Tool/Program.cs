...
static class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        root.AddCommand(CreateGitHubCommand());
    ...
    private static CliCommand CreateGitHubCommand()
    {
        var cmd = new CliCommand("github", "GitHub-related operations");
        cmd.AddCommand(CreateGitHubReleaseCommand());
        cmd.AddCommand(CreateGitHubPagesCommand());
        return cmd;
    }

    private static CliCommand CreateGitHubReleaseCommand()
    {
...
if (desktop != default)
            ...
            context.ExitCode = await deployer
                .CreateGitHubRelease(releaseConfig, repositoryConfig, releaseData, skipPublish)
                .WriteResult();
        });
    ...
    private static CliCommand CreateGitHubPagesCommand()
    {
        var cmd = new CliCommand("pages", "Publish a WebAssembly site to GitHub Pages");
