...
/// </summary>
internal sealed class PackableProjectDiscovery
{
    private readonly SolutionProjectReader projectReader;
    ...
    private static bool IsCurrentDirectoryInsideSubmodule(string submodulePath)
    {
    ...
    private List<SolutionProject> FilterEligibleProjects(FileInfo solution, IReadOnlyCollection<string> submodules)
    {
    ...
    private static bool ShouldSkip(string projectName)
    {
    ...
    private static bool IsInsideSubmodule(string projectPath, IReadOnlyCollection<string> submodules)
    {
    ...
    private static IReadOnlyList<string> BuildPatternPriority(FileInfo solution, string? pattern)
    {
    ...
    private static bool IsPackable(string projectPath)
    {
        try
        {
    ...
    private static IEnumerable<string> GetSubmodulePaths()
    {
